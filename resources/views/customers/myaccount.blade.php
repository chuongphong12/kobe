    ...
    <div class="row">
      <div class="col-12 text-center">
        ...
        <ul class="breadcrumb">
          ...
          <li class="current"><span>Tài khoản</span></li>
        </ul>
      </div>
    </div>
  </div>
          ...
          <div class="user-dashboard-tab flex-column flex-md-row">
            @if (Auth::user()->role_id == 1)
                ...
                <div class="user-dashboard-tab__content tab-content">
                  <div class="tab-pane fade show active" id="dashboard">
                    ...
                    <p>From your account dashboard. you can easily check &amp; view your <a href="{{route('voyager.dashboard')}}">Admin Dashboard</a>.
                    </p>
                  </div>
                </div>
            @else
              ...
              <a class="nav-link" data-toggle="pill" role="tab" href="#orders" aria-controls="orders"
                aria-selected="true">Đơn hàng</a>
              <a class="nav-link" data-toggle="pill" role="tab" href="#addresses" aria-controls="addresses"
                aria-selected="true">Địa Chỉ</a>
              <a class="nav-link active" data-toggle="pill" role="tab" href="#accountdetails" aria-controls="accountdetails"
            ...
            <div class="user-dashboard-tab__content tab-content">
                  ...
                  <table class="table text-center">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$item->status}}</td>
                        <td class="wide-column">{{$item->cost}}</td>
                        <td><a href="{{route('order.detail', $item->id_order)}}" class="btn btn-size-md">Xem</a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
                    ...
                    <div class="text-block">
                      ...
                      <div class="shipping-calculator-wrap">
                        ...
                        <form id="edit_address" class="form shipping-calculator-form hide-in-default"
                          action="{{route('cus.address', $cus['id_customer'])}}" method="POST">
                          @csrf
              ...
              <div class="tab-pane fade active" id="accountdetails">
                ...
                <form id="cus-infor" action="{{route('cus.edit', $cus['id_customer'])}}" method="POST" class="form form--account">
                  @csrf
                  <div class="row mb--20">
                    <div class="col-md-6 mb-sm--20">
                      <div class="form__group">
                        <label class="form__label" for="f_name">Họ Tên <span class="required">*</span></label>
                        <input type="text" name="fullname" id="f_name" class="form__input"
                          value="{{ $cus['last_name'] }}">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form__group">
                        ...
                        <input type="text" name="phone" id="l_name" class="form__input"
                          value="{{ $cus['phone'] }}">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-12">
                      <div class="form__group">
                        ...
                        <input type="text" name="d_name" id="d_name" class="form__input"
                          value="{{ $cus['name_customer'] }}" readonly>
                    ...
                    <div class="col-12">
                      <div class="form__group">
                        ...
                        <input type="email" name="email" id="email" class="form__input"
                          value="{{ $cus['email'] }}" readonly>
                      </div>
                    </div>
                  </div>
                </form>
                @if (empty(Auth::user()->provider_id))
                <form id="password" action="{{route('cus.password', Auth::id())}}" method="POST" class="form form--account">
                  @csrf
