  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-12 text-center">
        ...
        <h1 class="page-title">Cao cấp</h1>

        <ul class="breadcrumb">

          <li><a href="{{route('trang-chu')}}">Trang chủ</a></li>

          <li class="current"><span>Cao cấp</span></li>
                    ...
                    <div class="product-info">
                      ...
                      <div class="product-info-bottom">
                        ...
                        <div class="product-price-wrapper">
                          ...
                          <span class="money">{{number_format($product->cost,0)}}₫/kg</span>

                        </div>

                        <a href="{{route('cart.Qadd', $product->id_product)}}" class="add-to-cart pr--15">
