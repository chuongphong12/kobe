    ...
    <div class="row">
      ...
      <div class="col-12 text-center">
        ...
        <ul class="breadcrumb">
          ...
          <li class="current"><span>{{$product->product_type}}</span></li>
              ...
              <div class="product-gallery__large-image mb-sm--30">
                ...
                <div class="product-gallery__wrapper">
                  ...
                  <div class="element-carousel main-slider image-popup" data-slick-options='{
                    ...
                    <?php  $images = json_decode($product->detail_image); ?>
                    @if($images != null)
              ...
              <div class="product-gallery__nav-image">
                ...
                <div class="element-carousel nav-slider product-slide-nav slick-center-bottom" data-slick-options='{
                  ...
                  <figure class="product-gallery__nav-image--single">
                    ...
                    <img src="{{Voyager::image($product->multi_image)}}" alt="Products">
        ...
        <div class="col-xl-4 offset-xl-1 col-lg-5 product-main-details mt-md--50">
          ...
          <div class="product-summary pl-lg--30 pl-md--0">
            ...
            <p class="product-short-description mb--20">
              ...
              <form action="{{route('cart.add', $product->id_product)}}" method="POST" class="variation-form mb--20">
                @csrf
                <div class="product-size-variations d-flex align-items-center mb--15">

                  <p class="variation-label">Khối lượng:</p>
                ...
                <div
                  ...
                  <div class="quantity-wrapper d-flex align-items-center mr--30 mr-xs--0 mb-xs--30">
                    ...
                    <label class="quantity-label" for="qty">SL:</label>
                ...
                <div class="product-price-wrapper mb--25">
                  ...
                  <span class="money" id="money_key">Tổng giá : {{number_format($product->cost,0)}}₫</span>
                ...
                <div class="product-reviews">
                  ...
                  <ul class="review__list mb--40">
                    ...
                    <li class="review__item">
                      ...
                      <div>{{$product->name}} đã có {{count($product->ratings)}} đánh giá từ các người dùng khác nhau
                      </div>
                    </li>
                  </ul>
...
<input type="hidden" name="unit-price" id="unit-price" value="{{$product->cost}}">
