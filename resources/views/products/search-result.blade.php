        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="current"><span>Tìm Kiếm</span></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-7">
                                <div
                                    ...
                                    <p class="product-pages">Tìm thấy {{count($products)}} sản phẩm có từ khóa
                                ...
                                <div class="ft-product">
                                    <div class="product-inner">
                                        <div class="product-image">
                                            ...
                                            @if ($product->product_type == "Sữa")
                                            <a href="{{route('sua')}}"
                                                class="product-overlay"></a>
                                            @else
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="product-info-bottom">
                                                <div class="product-price-wrapper">
                                                    <span class="money">{{number_format($product->cost,0)}}₫/1kg</span>
                                                </div>
                                                <a href="{{route('cart.add', $product->id_product)}}"
